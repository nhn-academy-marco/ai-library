...
### 추천 영상
- [RAG 10분 이해하기](https://www.youtube.com/watch?v=example)
- [프롬프트 엔지니어링 기초](https://www.youtube.com/watch?v=example)

### 추가 학습
- Building Production RAG Applications (책)
- Prompt Engineering Guide (온라인 가이드)
