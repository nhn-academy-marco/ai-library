...
class BookVectorSearchTest {
    ...
    void testVectorSearch() {
        ...
        BookSearchRequest request = new BookSearchRequest(keyword, null, SearchType.VECTOR, null);
        PageRequest pageable = PageRequest.of(0, 5);

        // When
        com.nhnacademy.library.core.book.dto.BookSearchResult searchResult = bookSearchService.searchBooks(pageable, request);
